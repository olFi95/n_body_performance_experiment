...
impl NBodySimulator for SimdMultiThreaded {
...
impl SimdMultiThreaded {
    ...
    fn step_once(&mut self) {
        ...
        // Parallele SIMD-Berechnung mit Rayon
        let new_bodies: Vec<Body> = (0..n)
            ...
            .map(|i| {
                ...
                for chunk in 0..chunks {
                    ...
                    for k in 0..8 {
                        let idx = base_idx + k;
                        other_pos_x[k] = bodies_ref[idx].position[0];
                        other_pos_y[k] = bodies_ref[idx].position[1];
                        other_mass[k] = bodies_ref[idx].mass;
                    }
                ...
                for j in (chunks * 8)..n {
                    ...
                    Self::compute_force_scalar(&bodies_ref[i], &bodies_ref[j], &params, &mut force);
                }
